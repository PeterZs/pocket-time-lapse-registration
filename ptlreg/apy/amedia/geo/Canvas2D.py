...
from ptlreg.apy.amedia.signals.maths.Vec3 import *
from ptlreg.apy.amedia.signals.maths.Vec2 import *

class Canvas2D(draw.Drawing):
    def __init__(self, width=1080, height=720, origin=(0,0), idPrefix='d', displayInline=True, **svgArgs):
